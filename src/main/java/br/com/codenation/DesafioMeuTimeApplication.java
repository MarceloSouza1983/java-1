...
public class DesafioMeuTimeApplication implements MeuTimeInterface {
	...
	public void definirCapitao(Long idJogador) {
		...
		jogadores.entrySet()
				...
				.filter(j-> jogadorCapitao.getIdTime().equals(j.getValue()
						.getIdTime()) && j.getValue().isCapitao()) // implementar metodo getIsCapitao
				.forEach(j->j.getValue().setCapitao(false)); //

		jogadorCapitao.setCapitao(true);
	...
	public Long buscarCapitaoDoTime(Long idTime) {
		...
		Optional<Long> idJogador = jogadores.entrySet()
				...
				.filter(j->idTime.equals(j.getValue().getIdTime()) &&
						j.getValue().isCapitao())
				.map(Map.Entry::getKey)
				.findFirst();

		if (!idJogador.isPresent()) throw new CapitaoNaoInformadoException();
	...
	public Long buscarMelhorJogadorDoTime(Long idTime) {
		...
		if (!idMelhorJog.isPresent()) throw new JogadorNaoEncontradoException();
	...
	public Long buscarJogadorMaisVelho(Long idTime) {
		...
		Optional<Long> idJogMaisVelho = jogadores.entrySet()
				...
				.map(Map.Entry::getKey);
		if (!idJogMaisVelho.isPresent()) throw new JogadorNaoEncontradoException();
	...
	public Long buscarJogadorMaiorSalario(Long idTime) {
		...
		if (!idJogSalario.isPresent()) throw new JogadorNaoEncontradoException();
	...
	public List<Long> buscarTopJogadores(Integer top) {
		...
		if (jogadores.isEmpty()) new ArrayList<>();
